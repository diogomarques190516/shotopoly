...
const s = StyleSheet.create({
  ...
  glow:         { position: 'absolute', width: 320, height: 320, borderRadius: 160, backgroundColor: 'rgba(255,70,85,0.08)' },
  ...
  totalNum:     { fontSize: 84, fontFamily: FONTS.display, color: C.amber, lineHeight: 92 },
